                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item  ">
                                    <a href="{{ route('dashboard') }}" class="submenu-link">HOME</a>
                                </li>

                                <li class="submenu-item  ">
                                    <a href="{{ route('indexpenerbit') }}" class="submenu-link">ADMIN Penerbit</a>
                                </li>

                                <li class="submenu-item  ">
                                    <a href="{{ route('indexbuku') }}" class="submenu-link">ADMIN Buku</a>
                                </li>
        ...
        <div id="main">
            ...
            <div class="dropdown">
                <a href="#" id="topbarUserDropdown" class="user-dropdown d-flex align-items-center dropend dropdown-toggle float-end" data-bs-toggle="dropdown" aria-expanded="false">
                    <div class="text me-3">
                        <h6 class="user-dropdown-name text-secondary">sgsgsgsgsg</h6>
                        <p class="user-dropdown-status text-sm text-muted">shshshsh</p>
                    </div>
